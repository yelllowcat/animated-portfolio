...
const messagesByLocale: Record<Locale, Messages> = {
  es: {
    metadata: {
      title: "Mi Portafolio | Desarrollador y Diseñador",
      description:
        "Una selección de proyectos, estudios y habilidades enfocadas en experiencias web interactivas.",
    },
    brand: "Portafolio",
    ...
    hero: {
      ...
      titleLead: "Construyendo experiencias",
      titleAccent: "digitales",
      description:
        "Soy un desarrollador full-stack apasionado por crear aplicaciones web interactivas, accesibles y de alto rendimiento.",
      cta: "Ver proyectos",
    },
    projects: {
  ...
  en: {
    metadata: {
      ...
      description:
        "A showcase of projects, studies, and skills focused on interactive web experiences.",
    },
    brand: "Portfolio",
    ...
    hero: {
      ...
      titleLead: "Building digital",
      titleAccent: "experiences",
      description:
        "I'm a full-stack developer passionate about creating interactive, accessible, and performant web applications.",
      cta: "View projects",
    },
    projects: {
