...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative z-10 border-t border-white/10 bg-[#030014]/50 backdrop-blur-xl py-12 mt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex gap-6">
            <a
              ...
              className="p-3 rounded-xl bg-white/5 border border-white/10 text-neutral-400 hover:text-white hover:border-fuchsia-400/50 hover:shadow-[0_0_15px_rgba(232,121,249,0.3)] transition-all hover:scale-110"
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-sm font-medium tracking-wide text-neutral-500">
          <p>
            © {new Date().getFullYear()} {messages.brand} | {messages.footer.builtWith}
          </p>
        </div>
      </div>
    </footer>
